package be.fve.javaspringtutorials;

import be.fve.javaspringtutorials.modules.partialupdates.ProductMapper;
...
@EnableJpaAuditing
public class JavaSpringTutorialsApplication {

	public static void main(String[] args) throws IOException {
		SpringApplication.run(JavaSpringTutorialsApplication.class, args);
...
//	private static void example1Docx() throws IOException {
//
...
////		XWPFTemplate.compile("template/template.docx")
